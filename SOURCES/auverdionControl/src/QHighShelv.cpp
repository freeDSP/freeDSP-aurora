...
QHighShelv::QHighShelv( double gain, double freq, double slope,
  ...
  QDspBlock(parent), ui(new Ui::QHighShelv)
{
 ...
 *
 */
void QHighShelv::updateCoeffs( void )
{
 ...
 *
 */
void QHighShelv::on_doubleSpinBoxGain_valueChanged( double  )
{
  updateCoeffs();
  //sendDspParameter();
  emit valueChanged();
 ...
 *
 */
void QHighShelv::on_doubleSpinBoxFc_valueChanged( double  )
{
  updateCoeffs();
  //sendDspParameter();
  emit valueChanged();
 ...
 *
 */
void QHighShelv::on_doubleSpinBoxS_valueChanged( double  )
{
  updateCoeffs();
  //sendDspParameter();
  emit valueChanged();
 ...
 *
 */
void QHighShelv::on_pushButtonBypass_clicked()
{
 ...
 *
 */
uint32_t QHighShelv::getNumBytes( void )
{
  return 2*5 + 4*5;
}
