#ifndef QPLUGINCUSTOM_H
#define QPLUGINCUSTOM_H
...
class CPlugInCustom : public CDspPlugin
{

public:
  explicit CPlugInCustom( Vektorraum::tfloat samplerate );
  virtual ~CPlugInCustom( void );
   ...
   *
   */
  virtual tDspChannel getGuiForChannel( unsigned int chn, Vektorraum::tfloat samplerate, CFreeDspAurora* ptrdsp, QWidget* parent );
