...
#include "8channelsUSB_IC_1_PARAM.h"
 ...
 *
 */
CPlugIn8ChannelsUSB::CPlugIn8ChannelsUSB( tfloat samplerate )
{
  fs = samplerate;
 ...
 *
 */
CPlugIn8ChannelsUSB::~CPlugIn8ChannelsUSB( void )
{
  qDebug()<<"~CPlugIn8ChannelsUSB";
}
 ...
 *
 */
tDspChannel CPlugIn8ChannelsUSB::getGuiForChannel( unsigned int chn, tfloat fs, CFreeDspAurora* ptrdsp, QWidget* parent )
{
 ...
 *
 */
void CPlugIn8ChannelsUSB::setMasterVolume( double val, bool doSend )
{
  if( doSend )
  {
    QByteArray content;
