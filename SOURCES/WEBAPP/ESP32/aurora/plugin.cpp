...
void readPluginMeta(void) {
    ...
    if (filePluginMeta) {
        ...
        spdifOutputSelector.addrChnRight[ADDR_ANALOG] = static_cast<uint16_t>(jsonPluginMeta["spdifout"][6 +
                                                                                                         ADDR_ANALOG]);
        ...
        spdifOutputSelector.addrChnRight[ADDR_SPDIF] = static_cast<uint16_t>(jsonPluginMeta["spdifout"][6 +
                                                                                                        ADDR_SPDIF]);
