...
#include </Users/rkn/Documents/freeDSP/freeDSP-aurora/SOURCES/SIGMASTUDIO/8channels/8channels_IC_1_PARAM.h>
...
void PlugIn8Channels::selectSpdifLeftChannel( void )
{
...
void PlugIn8Channels::selectSpdifRightChannel( void )
{
...
void PlugIn8Channels::selectAnalogXLR( void )
{
  uint32_t data = 0x00000000;
  byte val[4];
  val[0] = (data >> 24 ) & 0xFF;
...
void PlugIn8Channels::selectAnalogRCA( void )
{
