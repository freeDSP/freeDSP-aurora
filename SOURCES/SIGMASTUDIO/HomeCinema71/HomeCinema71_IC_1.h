...
ADI_REG_TYPE R47_SPDIF_RESTART_IC_1_Default[REG_SPDIF_RESTART_IC_1_BYTE] = {
0x00, 0x01
};

/* Register Default - IC 1.SPDIF_TX_EN */
ADI_REG_TYPE R48_SPDIF_TX_EN_IC_1_Default[REG_SPDIF_TX_EN_IC_1_BYTE] = {
0x00, 0x01
};
...
void default_download_IC_1() {
	...
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_SPDIF_RESTART_IC_1_ADDR, REG_SPDIF_RESTART_IC_1_BYTE, R47_SPDIF_RESTART_IC_1_Default );
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_SPDIF_TX_EN_IC_1_ADDR, REG_SPDIF_TX_EN_IC_1_BYTE, R48_SPDIF_TX_EN_IC_1_Default );
